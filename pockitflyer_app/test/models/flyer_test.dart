...
void main() {
  group('Flyer Model Tests', () {
    test('creates Flyer with all fields', () {
      ...
      expect(flyer.location.address, 'Address');
      expect(flyer.validity.isValid, true);
    }, tags: ['tdd_green']);
    ...
    test('creates Flyer with empty images list', () {
      final flyer = Flyer(
        ...
        creator: Creator(id: 2, username: 'user2', profilePicture: null),
        images: [],
    ...
    test('creates Flyer with single image', () {
      final flyer = Flyer(
        ...
        description: 'Description',
        creator: Creator(id: 3, username: 'user3', profilePicture: null),
        images: [FlyerImage(url: 'single.jpg', order: 0)],
        location: Location(address: 'Addr', lat: 0, lng: 0, distanceKm: 5.0),
        validity: Validity(
          validFrom: DateTime(2025, 1, 1),
          validUntil: DateTime(2025, 12, 31),
          isValid: true,
    ...
    test('creates Flyer from JSON', () {
      final json = {
        ...
        'title': 'Test',
        'description': 'Desc',
        'creator': {'id': 1, 'username': 'user', 'profile_picture': null},
        'images': [
          {'url': 'img.jpg', 'order': 0}
        ],
        'location': {
    ...
    test('converts Flyer to JSON', () {
      final flyer = Flyer(
        ...
        title: 'T',
        description: 'D',
        creator: Creator(id: 1, username: 'u', profilePicture: null),
        images: [FlyerImage(url: 'i.jpg', order: 0)],
        location: Location(address: 'A', lat: 0, lng: 0, distanceKm: null),
        validity: Validity(
          validFrom: DateTime(2025, 1, 1),
          validUntil: DateTime(2025, 12, 31),
          isValid: true,
